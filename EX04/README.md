...
## ✅ Key Learnings
- Importance of text preprocessing and vectorization for Multinomial NB  
- Role of feature scaling in Gaussian NB for tabular data  
- Understanding probabilistic classification and feature independence assumption  
- Analyzing model errors through misclassifications and feature importance  
- Practical demonstration of Naive Bayes efficiency on both text and numerical data  
- Comparison of Naive Bayes with other classifiers like Logistic Regression  

---

## 📌 Conclusion
This experiment demonstrates how Naive Bayes classifiers can be applied to text and tabular classification problems, highlighting the importance of preprocessing, model evaluation, and probabilistic interpretation in real-world machine learning tasks.
# EX04 – Naive Bayes Classifier using Scikit-Learn
